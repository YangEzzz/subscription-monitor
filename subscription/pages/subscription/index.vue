...
<!-- 统计 -->
			...
			@currency-change="statsCurrency = $event"
...
<script>
	...
	import { createSubscriptionPageState, subscriptionComputed, subscriptionLifecycle, subscriptionMethods } from './subscription-page-logic.js'
	...
	export default {
		...
		data() { return createSubscriptionPageState() },
		computed: subscriptionComputed,
		onLoad() { subscriptionLifecycle.onLoad.call(this) },
		onBackPress() { return subscriptionLifecycle.onBackPress.call(this) },
