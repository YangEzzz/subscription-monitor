...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    c: common_vendor.o((...args) => $options.setTabBarBadge && $options.setTabBarBadge(...args), "5b"),
    d: common_vendor.t(!$data.hasShownTabBarRedDot ? "显示红点" : "移除红点"),
    e: common_vendor.o((...args) => $options.showTabBarRedDot && $options.showTabBarRedDot(...args), "25"),
    f: common_vendor.t(!$data.hasCustomedStyle ? "自定义Tab样式" : "移除自定义样式"),
    g: common_vendor.o((...args) => $options.customStyle && $options.customStyle(...args), "fd"),
    h: common_vendor.t(!$data.hasCustomedItem ? "自定义Tab信息" : "移除自定义信息"),
    i: common_vendor.o((...args) => $options.customItem && $options.customItem(...args), "90"),
    j: common_vendor.t(!$data.hasHiddenTabBar ? "隐藏TabBar" : "显示TabBar"),
    k: common_vendor.o((...args) => $options.hideTabBar && $options.hideTabBar(...args), "35"),
    l: common_vendor.o((...args) => $options.navigateBack && $options.navigateBack(...args), "e2")
  };
}
