...
const _sfc_main = {
  ...
  methods: {
    ...
    updateVideo(isNext) {
      ...
      common_vendor.index.__f__("log", "at pages/template/swiper-vertical/swiper-vertical.nvue:139", "v:" + this._videoIndex + " d:" + this._videoDataIndex + "; next v:" + this.getNextIndex(
        isNext
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    b: $data.circular,
    c: common_vendor.o((...args) => $options.onSwiperChange && $options.onSwiperChange(...args), "0d")
  };
}
