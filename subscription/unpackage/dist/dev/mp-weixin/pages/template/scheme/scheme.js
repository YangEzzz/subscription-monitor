    ...
    openMarket(marketPackageName) {
      ...
      if (typeof marketPackageName == "undefined") {
        plus.runtime.openURL(appurl, function(res) {
          common_vendor.index.__f__("log", "at pages/template/scheme/scheme.vue:61", res);
        });
      } else {
        if (plus.os.name == "Android") {
          plus.runtime.openURL(appurl, function(res) {
    ...
    openMap() {
      ...
      if (plus.os.name == "Android") {
        ...
        plus.nativeUI.actionSheet({ title: "选择地图应用", cancel: "取消", buttons: [{ title: "Apple地图" }, { title: "百度地图" }, { title: "高德地图" }] }, function(e) {
          common_vendor.index.__f__("log", "at pages/template/scheme/scheme.vue:117", "e.index: " + e.index);
          switch (e.index) {
            case 1:
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    b: common_vendor.o(($event) => $options.openBrowser("https://uniapp.dcloud.io/h5"), "41"),
    c: common_vendor.o(($event) => $options.openMarket(), "4d"),
    d: common_vendor.o(($event) => $options.openMarket("com.tencent.android.qqdownloader"), "4f"),
    e: common_vendor.o(($event) => $options.openTaobao("taobao://s.taobao.com/search?q=uni-app"), "47"),
    f: common_vendor.o(($event) => $options.openMap(), "f4"),
    g: common_vendor.o((...args) => $options.openQQ && $options.openQQ(...args), "1e")
  };
}
