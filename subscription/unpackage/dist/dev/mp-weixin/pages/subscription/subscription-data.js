...
function createSeedSubscriptions() {
  const today = toDateKey(/* @__PURE__ */ new Date());
  return [
    { id: 1, name: "网易云音乐黑胶 VIP", plan: "黑胶 VIP", logo: "音", color: "#ef3943", amount: 15, currency: "CNY", cycle: "每月", nextBillingDate: addDays(today, 2), payment: "微信支付", category: "音乐", status: "active", autoRenew: true, reminders: [7, 3, 1, 0], note: "常用音乐会员", cancelGuide: "网易云音乐 App > 会员中心 > 自动续费管理", createdAt: Date.now() - 6e4 },
    { id: 2, name: "iCloud+ 200GB", plan: "200GB", logo: "云", color: "#3f98ee", amount: 21, currency: "CNY", cycle: "每月", nextBillingDate: addDays(today, 4), payment: "支付宝", category: "云存储", status: "active", autoRenew: true, reminders: [7, 3, 1], note: "", cancelGuide: "iPhone 设置 > Apple ID > iCloud > 管理储存空间", createdAt: Date.now() - 5e4 },
...
exports.createSeedSubscriptions = createSeedSubscriptions;
