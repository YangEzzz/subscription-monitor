...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    d: common_vendor.o($options.change, "9a"),
    e: common_vendor.o($options.monthSwitch, "d7"),
    f: common_vendor.p({
    ...
    h: common_vendor.o((...args) => $options.open && $options.open(...args), "cb"),
    i: common_vendor.sr("calendar", "0125d1ba-4"),
    j: common_vendor.o($options.confirm, "37"),
    k: common_vendor.o($options.close, "d4"),
    l: common_vendor.p({
      ["clear-date"]: true,
      date: $data.info.date,
