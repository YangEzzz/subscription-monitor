  ...
  return {
    ...
    e: common_vendor.f($data.tableData, (item, index, i0) => {
      return {
        ...
        b: "0dfb47fc-7-" + i0 + "," + ("0dfb47fc-6-" + i0),
        c: common_vendor.t(item.name),
        d: "0dfb47fc-8-" + i0 + "," + ("0dfb47fc-6-" + i0),
        e: common_vendor.t(item.address),
        f: "0dfb47fc-9-" + i0 + "," + ("0dfb47fc-6-" + i0),
        g: "0dfb47fc-10-" + i0 + "," + ("0dfb47fc-6-" + i0),
        h: index,
        i: "0dfb47fc-6-" + i0 + ",0dfb47fc-0"
      };
    }),
    f: common_vendor.p({
      align: "center"
    }),
    g: common_vendor.sr("table", "0dfb47fc-0"),
    h: common_vendor.o($options.selectionChange, "6d"),
    i: common_vendor.p({
    ...
    j: common_vendor.o($options.change, "79"),
    k: common_vendor.p({
      ["show-icon"]: true,
