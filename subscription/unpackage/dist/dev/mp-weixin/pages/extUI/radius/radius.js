...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    c: common_vendor.o(($event) => $options.change($event, 1), "a2"),
    d: common_vendor.o(($event) => $data.formData.direction = $event, "db"),
    e: common_vendor.p({
      multiple: true,
      localdata: $data.directionData,
      modelValue: $data.formData.direction
    }),
    f: common_vendor.o(($event) => $options.change($event, 2), "d1"),
    g: common_vendor.o(($event) => $data.formData.size = $event, "b0"),
    h: common_vendor.p({
