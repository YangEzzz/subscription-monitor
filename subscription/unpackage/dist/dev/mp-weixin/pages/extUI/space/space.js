...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    d: common_vendor.o(($event) => $options.change($event, 1), "33"),
    e: common_vendor.o(($event) => $data.formData.margin = $event, "b2"),
    f: common_vendor.p({
      multiple: true,
      localdata: $data.directionData,
      modelValue: $data.formData.margin
    }),
    g: common_vendor.o(($event) => $options.change($event, 1), "87"),
    h: common_vendor.o(($event) => $data.formData.marginSize = $event, "a1"),
    i: common_vendor.p({
      localdata: $data.sizeData,
      modelValue: $data.formData.marginSize
    }),
    j: common_vendor.o(($event) => $options.change($event, 2), "85"),
    k: common_vendor.o(($event) => $data.formData.padding = $event, "75"),
    l: common_vendor.p({
      multiple: true,
      localdata: $data.directionData,
      modelValue: $data.formData.padding
    }),
    m: common_vendor.o(($event) => $options.change($event, 3), "33"),
    n: common_vendor.o(($event) => $data.formData.paddingSize = $event, "b4"),
    o: common_vendor.p({
      localdata: $data.sizeData,
