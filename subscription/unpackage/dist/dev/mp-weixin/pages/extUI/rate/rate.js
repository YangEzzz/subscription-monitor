...
const _sfc_main = {
  ...
  methods: {
    onChange(e) {
      common_vendor.index.__f__("log", "at pages/extUI/rate/rate.nvue:55", "rate发生改变:" + JSON.stringify(e));
    }
  }
};
if (!Array) {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    b: common_vendor.o($options.onChange, "7d"),
    c: common_vendor.o(($event) => $data.rateValue = $event, "b1"),
    d: common_vendor.p({
    ...
    f: common_vendor.o($options.onChange, "53"),
    g: common_vendor.p({
      touchable: false,
      value: 5
    }),
