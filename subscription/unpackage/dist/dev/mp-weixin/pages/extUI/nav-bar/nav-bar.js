...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    a: common_vendor.o($options.back, "ab"),
    b: common_vendor.p({
      dark: true,
      fixed: true,
      shadow: true,
    ...
    f: common_vendor.o($options.back, "e8"),
    g: common_vendor.p({
      shadow: true,
      ["left-icon"]: "left",
      title: "开启阴影"
    ...
    i: common_vendor.o($options.back, "1b"),
    j: common_vendor.p({
      shadow: true,
      ["left-icon"]: "left",
      dark: true,
    ...
    x: common_vendor.o((...args) => $options.confirm && $options.confirm(...args), "17"),
    y: common_vendor.p({
      title: "自定义内容",
