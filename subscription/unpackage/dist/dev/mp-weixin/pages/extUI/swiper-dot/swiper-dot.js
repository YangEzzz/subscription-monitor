...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    b: common_vendor.o((...args) => $options.change && $options.change(...args), "42"),
    c: $data.swiperDotIndex,
    d: common_vendor.o($options.clickItem, "39"),
    e: common_vendor.p({
      info: $data.info,
    ...
    g: common_vendor.o(($event) => $options.selectMode("default", 0), "5b"),
    h: $data.modeIndex === 1 ? 1 : "",
    i: common_vendor.o(($event) => $options.selectMode("dot", 1), "8e"),
    j: $data.modeIndex === 2 ? 1 : "",
    k: common_vendor.o(($event) => $options.selectMode("round", 2), "4e"),
    l: $data.modeIndex === 3 ? 1 : "",
    m: common_vendor.o(($event) => $options.selectMode("nav", 3), "4c"),
    n: $data.modeIndex === 4 ? 1 : "",
    o: common_vendor.o(($event) => $options.selectMode("indexes", 4), "5a"),
    p: common_vendor.p({
      title: "模式选择",
      type: "line"
    }),
