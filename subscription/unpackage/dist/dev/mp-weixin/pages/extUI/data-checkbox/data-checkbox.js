...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    c: common_vendor.o(($event) => $data.radio1 = $event, "3b"),
    d: common_vendor.p({
      localdata: $data.sex,
    ...
    g: common_vendor.o(($event) => $data.checkbox1 = $event, "c3"),
    h: common_vendor.p({
      multiple: true,
    ...
    k: common_vendor.o(($event) => $data.checkbox6 = $event, "a1"),
    l: common_vendor.p({
      min: "1",
      max: "2",
      multiple: true,
    ...
    o: common_vendor.o(($event) => $data.radio2 = $event, "ef"),
    p: common_vendor.p({
      mode: "button",
      localdata: $data.sex,
    ...
    r: common_vendor.o(($event) => $data.checkbox2 = $event, "ba"),
    s: common_vendor.p({
      mode: "button",
      multiple: true,
      localdata: $data.hobby,
    ...
    w: common_vendor.o(($event) => $data.radio3 = $event, "4b"),
    x: common_vendor.p({
      mode: "tag",
      localdata: $data.sex,
    ...
    z: common_vendor.o(($event) => $data.checkbox3 = $event, "37"),
    A: common_vendor.p({
      mode: "tag",
      multiple: true,
      localdata: $data.hobby,
    ...
    D: common_vendor.o(($event) => $data.radio4 = $event, "e2"),
    E: common_vendor.p({
      mode: "button",
      localdata: $data.sex1,
    ...
    G: common_vendor.o(($event) => $data.checkbox4 = $event, "77"),
    H: common_vendor.p({
      mode: "button",
      multiple: true,
    ...
    K: common_vendor.o(($event) => $data.radio5 = $event, "10"),
    L: common_vendor.p({
      selectedColor: "red",
      localdata: $data.sex1,
    ...
    N: common_vendor.o(($event) => $data.checkbox5 = $event, "a0"),
    O: common_vendor.p({
      selectedColor: "red",
      multiple: true,
      localdata: $data.hobby2,
