...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    f: common_vendor.sr("collapse", "3dd3eac4-2,3dd3eac4-1"),
    g: common_vendor.o($options.change, "a3"),
    h: common_vendor.o(($event) => $data.value = $event, "89"),
    i: common_vendor.p({
    ...
    k: common_vendor.o((...args) => $options.add && $options.add(...args), "0c"),
    l: common_vendor.p({
      title: "使用动画",
      ["show-animation"]: true
    }),
    ...
    r: common_vendor.o($options.change, "db"),
    s: common_vendor.o(($event) => $data.accordionVal = $event, "a8"),
    t: common_vendor.p({
      accordion: true,
    ...
    G: common_vendor.o($options.onClick, "c7"),
    H: common_vendor.p({
      title: "开启点击反馈",
      clickable: true,
      showArrow: true
