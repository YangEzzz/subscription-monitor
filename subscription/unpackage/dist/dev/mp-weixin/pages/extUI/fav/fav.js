...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    b: common_vendor.o(($event) => $options.favClick(0), "3d"),
    c: common_vendor.p({
      checked: $data.checkList[0]
    }),
    d: common_vendor.o(($event) => $options.favClick(1), "66"),
    e: common_vendor.p({
      checked: $data.checkList[1],
      star: false
    }),
    f: common_vendor.o(($event) => $options.favClick(2), "17"),
    g: common_vendor.p({
    ...
    h: common_vendor.o(($event) => $options.favClick(3), "de"),
    i: common_vendor.p({
    ...
    k: common_vendor.o(($event) => $options.favClick(4), "91"),
    l: common_vendor.p({
    ...
    n: common_vendor.o(($event) => $options.favClick(5), "a6"),
    o: common_vendor.p({
