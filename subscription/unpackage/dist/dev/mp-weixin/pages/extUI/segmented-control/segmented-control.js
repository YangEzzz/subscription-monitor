...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    b: common_vendor.o($options.onClickItem, "78"),
    c: common_vendor.p({
    ...
    j: common_vendor.o((...args) => $options.styleChange && $options.styleChange(...args), "e9"),
    k: common_vendor.p({
      title: "Color",
      type: "line"
    }),
    ...
    m: common_vendor.o((...args) => $options.colorChange && $options.colorChange(...args), "1a")
  });
}
