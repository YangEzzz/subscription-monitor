...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    g: common_vendor.o((...args) => $options.getNetworkType && $options.getNetworkType(...args), "91"),
    h: $data.hasNetworkType === true && $data.networkType === "wifi"
  }, $data.hasNetworkType === true && $data.networkType === "wifi" ? {
    i: common_vendor.o((...args) => $options.getConnectedWifi && $options.getConnectedWifi(...args), "bb")
  } : {}, {
    j: common_vendor.o((...args) => $options.clear && $options.clear(...args), "e3")
  });
}
