...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    b: common_vendor.o((...args) => $options.openDB && $options.openDB(...args), "64"),
    c: common_vendor.o((...args) => $options.executeSQL && $options.executeSQL(...args), "04"),
    d: common_vendor.o((...args) => $options.selectSQL && $options.selectSQL(...args), "24"),
    e: common_vendor.o((...args) => $options.droptable && $options.droptable(...args), "6c"),
    f: common_vendor.o((...args) => $options.closeDB && $options.closeDB(...args), "e8"),
    g: common_vendor.o((...args) => $options.isOpenDB && $options.isOpenDB(...args), "23")
  };
}
