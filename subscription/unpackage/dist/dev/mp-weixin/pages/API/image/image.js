...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    c: $data.sourceType,
    d: common_vendor.o((...args) => $options.sourceTypeChange && $options.sourceTypeChange(...args), "d2"),
    e: $data.sourceTypeIndex,
    f: common_vendor.t($data.sizeType[$data.sizeTypeIndex]),
    g: $data.sizeType,
    h: common_vendor.o((...args) => $options.sizeTypeChange && $options.sizeTypeChange(...args), "a2"),
    i: $data.sizeTypeIndex,
    j: common_vendor.t($data.count[$data.countIndex]),
    k: $data.count,
    l: common_vendor.o((...args) => $options.countChange && $options.countChange(...args), "e2"),
    ...
    o: common_vendor.o((...args) => $options.chooseImage && $options.chooseImage(...args), "80")
  };
}
