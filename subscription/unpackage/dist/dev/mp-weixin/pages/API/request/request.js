...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    b: $data.res,
    c: common_vendor.o((...args) => $options.sendRequest && $options.sendRequest(...args), "f6"),
    d: $data.loading,
    e: common_vendor.o(($event) => $options.sendRequest("promise"), "18"),
    f: $data.loading,
    g: common_vendor.o(($event) => $options.sendRequest("await"), "bb"),
    h: $data.loading
  };
}
