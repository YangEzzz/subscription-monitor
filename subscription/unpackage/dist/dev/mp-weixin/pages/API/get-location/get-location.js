...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    h: common_vendor.o((...args) => $options.getLocation && $options.getLocation(...args), "d8"),
    i: common_vendor.o((...args) => $options.clear && $options.clear(...args), "9d"),
    j: common_vendor.o((...args) => $options.openSetting && $options.openSetting(...args), "70"),
    k: common_vendor.o(($event) => $options.togglePopup(""), "04"),
    l: common_vendor.o(($event) => $options.togglePopup(""), "3b"),
    m: common_vendor.p({
