      ...
      common_vendor.index.downloadFile({
        ...
        success: (res) => {
          common_vendor.index.openDocument({
            ...
            success: () => {
              common_vendor.index.__f__("log", "at pages/API/file/file.vue:108", "打开文档成功");
            }
          });
        }
      });
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    g: common_vendor.o((...args) => $options.chooseImage && $options.chooseImage(...args), "a8")
  } : {}, {
    h: common_vendor.o((...args) => $options.saveFile && $options.saveFile(...args), "22"),
    i: common_vendor.o((...args) => $options.clear && $options.clear(...args), "d1"),
    j: common_vendor.o((...args) => $options.openDocument && $options.openDocument(...args), "c0")
  });
}
