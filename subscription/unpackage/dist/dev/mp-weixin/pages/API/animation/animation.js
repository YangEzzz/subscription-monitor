...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    c: common_vendor.o((...args) => $options.rotate && $options.rotate(...args), "f1"),
    d: common_vendor.o((...args) => $options.scale && $options.scale(...args), "6a"),
    e: common_vendor.o((...args) => $options.translate && $options.translate(...args), "30"),
    f: common_vendor.o((...args) => $options.skew && $options.skew(...args), "80"),
    g: common_vendor.o((...args) => $options.rotateAndScale && $options.rotateAndScale(...args), "4d"),
    h: common_vendor.o((...args) => $options.rotateThenScale && $options.rotateThenScale(...args), "fb"),
    i: common_vendor.o((...args) => $options.all && $options.all(...args), "38"),
    j: common_vendor.o((...args) => $options.allInQueue && $options.allInQueue(...args), "71"),
    k: common_vendor.o((...args) => $options.reset && $options.reset(...args), "69")
  };
}
