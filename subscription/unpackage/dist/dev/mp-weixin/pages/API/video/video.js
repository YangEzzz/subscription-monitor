...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    c: $data.sourceType,
    d: common_vendor.o((...args) => $options.sourceTypeChange && $options.sourceTypeChange(...args), "09"),
    ...
    g: common_vendor.o((...args) => $options.radioChange && $options.radioChange(...args), "8a"),
    h: !$data.src
  }, !$data.src ? {
    i: common_vendor.o((...args) => $options.chooseVideo && $options.chooseVideo(...args), "99")
  } : {
    j: $data.src
  });
}
