  ...
  methods: {
    ...
    saveVideo() {
      common_vendor.index.chooseVideo({
        ...
        sourceType: ["camera"],
        success: (res) => {
          common_vendor.index.__f__("log", "at pages/API/save-media/save-media.vue:76", res.tempFilePath);
    ...
    getTempFilePath(url, types) {
      let obj = {
        filePath: url,
        success: () => {
          common_vendor.index.__f__("log", "at pages/API/save-media/save-media.vue:108", "save success");
          common_vendor.index.showModal({
            content: "保存成功",
            showCancel: false
          });
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    d: common_vendor.o((...args) => $options.saveImage && $options.saveImage(...args), "df"),
    e: $data.videoPath !== ""
  }, $data.videoPath !== "" ? {
    f: $data.videoPath,
    g: common_vendor.o((...args) => $options.videoErrorCallback && $options.videoErrorCallback(...args), "11")
  } : {}, {
    h: common_vendor.o((...args) => $options.saveVideo && $options.saveVideo(...args), "f7")
  });
}
