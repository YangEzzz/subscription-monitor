...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    b: common_vendor.o((...args) => $options.checkIsSupportSoterAuthentication && $options.checkIsSupportSoterAuthentication(...args), "38"),
    c: common_vendor.o((...args) => $options.checkIsSoterEnrolledInDeviceFingerPrint && $options.checkIsSoterEnrolledInDeviceFingerPrint(...args), "b0"),
    d: common_vendor.o((...args) => $options.checkIsSoterEnrolledInDeviceFaceID && $options.checkIsSoterEnrolledInDeviceFaceID(...args), "ee"),
    e: common_vendor.o((...args) => $options.startSoterAuthenticationFingerPrint && $options.startSoterAuthenticationFingerPrint(...args), "ba"),
    f: common_vendor.o((...args) => $options.startSoterAuthenticationFaceID && $options.startSoterAuthenticationFaceID(...args), "6c"),
