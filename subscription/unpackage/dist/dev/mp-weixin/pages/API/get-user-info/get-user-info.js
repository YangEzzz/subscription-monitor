...
const _sfc_main = {
  ...
  methods: {
    ...
    getUserInfo() {
      ...
      if (this.isUniverifyLogin) {
        this.getPhoneNumber(common_vendor.index.getStorageSync("univerifyInfo")).then((phoneNumber) => {
          ...
          common_vendor.index.__f__("error", "at pages/API/get-user-info/get-user-info.vue:65", "getUserInfo fail:", err);
      ...
      common_vendor.index.getUserInfo({
        ...
        fail: (error) => {
          common_vendor.index.__f__("log", "at pages/API/get-user-info/get-user-info.vue:90", "getUserInfo fail", error);
    ...
    mpGetUserInfo(result) {
      common_vendor.index.__f__("log", "at pages/API/get-user-info/get-user-info.vue:133", "mpGetUserInfo", result);
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    g: common_vendor.o((...args) => $options.mpGetUserInfo && $options.mpGetUserInfo(...args), "9a"),
    h: common_vendor.o((...args) => $options.clear && $options.clear(...args), "15")
  });
}
