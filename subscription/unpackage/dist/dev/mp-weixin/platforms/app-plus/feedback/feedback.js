  ...
  methods: {
    ...
    send() {
      ...
      this.request(this.sendDate, imgs).then((res) => {
        ...
        common_vendor.index.__f__("log", "at platforms/app-plus/feedback/feedback.vue:173", err);
      });
    },
    /**
     * 发送请求到后台
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    a: common_vendor.o((...args) => $options.chooseMsg && $options.chooseMsg(...args), "55"),
    b: $data.sendDate.content,
    c: common_vendor.o(($event) => $data.sendDate.content = $event.detail.value, "56"),
    ...
    f: common_vendor.o((...args) => $options.chooseImg && $options.chooseImg(...args), "c2"),
    g: $data.imageList.length < 5,
    h: $data.sendDate.contact,
    i: common_vendor.o(($event) => $data.sendDate.contact = $event.detail.value, "f1"),
    j: common_vendor.o(($event) => $data.sendDate.score = $event, "a5"),
    k: common_vendor.p({
      color: "#bbb",
      modelValue: $data.sendDate.score
    }),
    l: common_vendor.o((...args) => $options.send && $options.send(...args), "6c")
  };
}
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render]]);
wx.createPage(MiniProgramPage);
//# sourceMappingURL=../../../../.sourcemap/mp-weixin/platforms/app-plus/feedback/feedback.js.map
