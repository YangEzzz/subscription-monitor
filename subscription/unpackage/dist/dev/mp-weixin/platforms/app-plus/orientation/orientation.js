...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    b: common_vendor.o((...args) => $options.getOrient && $options.getOrient(...args), "a6"),
    c: common_vendor.o((...args) => $options.watchOrient && $options.watchOrient(...args), "f6"),
    d: common_vendor.o((...args) => $options.watchStop && $options.watchStop(...args), "22"),
    e: $data.value
  };
}
