...
const _sfc_main = {
  ...
  onLoad: function() {
    common_vendor.index.getProvider({
      service: "push",
      success: (e) => {
        common_vendor.index.__f__("log", "at platforms/app-plus/push/push.vue:32", "success", e);
        this.provider = e.provider;
      },
      fail: (e) => {
        common_vendor.index.__f__("log", "at platforms/app-plus/push/push.vue:36", "获取推送通道失败", e);
      }
    });
  },
  onUnload: function() {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    c: common_vendor.o((...args) => $options.listenTranMsg && $options.listenTranMsg(...args), "33"),
    d: common_vendor.o((...args) => $options.requireTranMsg && $options.requireTranMsg(...args), "2b"),
    e: $data.tranMsg,
    f: common_vendor.o(($event) => $data.tranMsg = $event.detail.value, "82")
  } : {});
}
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render]]);
wx.createPage(MiniProgramPage);
//# sourceMappingURL=../../../../.sourcemap/mp-weixin/platforms/app-plus/push/push.js.map
