...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    b: common_vendor.o((...args) => $options.getProximity && $options.getProximity(...args), "83"),
    c: common_vendor.o((...args) => $options.watchProximity && $options.watchProximity(...args), "23"),
    d: common_vendor.o((...args) => $options.watchStop && $options.watchStop(...args), "e1"),
    e: $data.value
  };
}
