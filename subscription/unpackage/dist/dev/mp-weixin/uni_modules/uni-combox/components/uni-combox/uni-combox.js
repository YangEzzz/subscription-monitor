...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    f: common_vendor.o((...args) => $options.onFocus && $options.onFocus(...args), "cc"),
    g: common_vendor.o((...args) => $options.onBlur && $options.onBlur(...args), "d9"),
    h: $data.inputVal,
    i: !$data.inputVal || !$props.clearAble
  }, !$data.inputVal || !$props.clearAble ? {
    j: common_vendor.o($options.toggleSelector, "5d"),
    k: common_vendor.p({
    ...
    m: common_vendor.o($options.clean, "f6"),
    n: common_vendor.p({
      type: "clear",
      size: "24",
      color: "#999"
