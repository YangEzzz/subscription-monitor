...
const _sfc_main = {
  ...
  mixins: [common_vendor.wr.mixinDatacom || {}],
  props: {
    localdata: {
      type: Array,
      default() {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    h: common_vendor.o((...args) => $options.clearVal && $options.clearVal(...args), "8c")
  } : {
    i: common_vendor.p({
    ...
    j: common_vendor.o((...args) => $options.toggleSelector && $options.toggleSelector(...args), "8c"),
    k: $data.showSelector
  }, $data.showSelector ? {
    l: common_vendor.o((...args) => $options.toggleSelector && $options.toggleSelector(...args), "3b")
  } : {}, {
    m: $data.showSelector
