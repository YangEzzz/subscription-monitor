...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    E: common_vendor.o((...args) => $options.clickMore && $options.clickMore(...args), "1a")
  }) : {}, {
    F: $options.isShowClose
  }, $options.isShowClose ? {
    G: common_vendor.o($options.close, "11"),
    H: common_vendor.p({
      type: "closeempty",
      color: $props.color,
      size: $props.fontSize * 1.1
    ...
    J: common_vendor.o((...args) => $options.onClick && $options.onClick(...args), "2b")
  }) : {});
}
