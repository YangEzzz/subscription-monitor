...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    d: common_vendor.o((...args) => $options.touchStart && $options.touchStart(...args), "3d"),
    e: common_vendor.o((...args) => $options.touchMove && $options.touchMove(...args), "6e"),
    f: common_vendor.o((...args) => $options.touchEnd && $options.touchEnd(...args), "1e"),
    g: common_vendor.o((...args) => $options.mousedown && $options.mousedown(...args), "9b"),
    h: common_vendor.o((...args) => $options.mousemove && $options.mousemove(...args), "87"),
    i: common_vendor.o((...args) => $options.mouseleave && $options.mouseleave(...args), "81"),
    j: $data.touchmove
  }, $data.touchmove ? {
