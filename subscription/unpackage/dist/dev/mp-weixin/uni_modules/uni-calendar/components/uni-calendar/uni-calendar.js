...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    c: common_vendor.o((...args) => $options.clean && $options.clean(...args), "62")
  } : {}, {
    ...
    g: common_vendor.o((...args) => $options.close && $options.close(...args), "86"),
    h: common_vendor.t($options.okText),
    i: common_vendor.o((...args) => $options.confirm && $options.confirm(...args), "67")
  } : {}, {
    j: common_vendor.o((...args) => $options.pre && $options.pre(...args), "1a"),
    k: common_vendor.t(($data.nowDate.year || "") + " / " + ($data.nowDate.month || "")),
    l: $props.date,
    m: common_vendor.o((...args) => $options.bindDateChange && $options.bindDateChange(...args), "06"),
    n: common_vendor.o((...args) => $options.next && $options.next(...args), "14"),
    o: common_vendor.t($options.todayText),
    p: common_vendor.o((...args) => $options.backToday && $options.backToday(...args), "ef"),
    q: $props.showMonth
  }, $props.showMonth ? {
